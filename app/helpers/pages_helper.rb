module PagesHelper
	...
	def prologue
		a = content_tag :p do
			...
			wonderful, kind, and caring person. For those who 
	...
	def nightmare
		...
		c = content_tag :p do
			"Her head slammed into the solid ground and her collar bone 
			shattered. Laurie's skull was split in half. She laid there 
			helpless, desperately clinging to life. For several hours she 
	...
	def aftermath
		a = content_tag :p do
			...
			but her wounds were extensive. With the injuries she sustained, 
			a full recovery was doubtful. Her skull was nearly broken in 
			half. Her collar bone was shattered and her body was screaming in 
			pain. Permanent damage to her nervous system seemed inevitable; 
			other than death, this was the worst possible outcome."
		end
		b = content_tag :p do
			"Shortly after her admission into the ICU, 4 neurosurgeons made 
			their way into the room. They began operating on her head, 
			desperately doing everything they can to save her life. 
			After countless hours of surgery, a glimpse of hope surfaced. 
			The operation was successful; however, Laurie was still in critical 
			condition and would remain in the ICU for a total of five days. 
			Upon her release from the ICU, she would spend the next 2 weeks 
			in the hospital under 24 hour supervision and care."
		end
		c = content_tag :p do
			...
			Laurie was immediately admitted into a rehabilitation center  
			where she would undergo excruciating physical therapy in 
			hopes of restoring her mind, body, and spirit to its former self. 
			After a week of intense therapy, she was 
	...
	def epilogue
		...
		c = content_tag :p do
			...
			the kindness of your heart, please continue to send your prayers 
			and provide her with your relentless support. Thank you very much."
		end
		a + b + c
	end
end